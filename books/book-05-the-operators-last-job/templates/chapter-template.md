...
::: {.impact-opener number="00" title="CHAPTER TITLE"}
A one-sentence tension statement. No definition. No lesson.
:::
...
Show the work beneath the task: interpreting, waiting, comparing, calling, negotiating, choosing the least harmful option, and carrying uncertainty.

::: {.decision-ledger}
| Decision Ledger | |
|---|---|
| **Action** | What was performed, proposed, or refused? |
| **Authority** | Who had the right to permit it? |
| **Hidden assumption** | What had to be true for it to be safe? |
| **Cost of being wrong** | What would be lost if that assumption failed? |
:::
...
## What the system could not carry
...
State the chapter’s two-sentence difficulty. Examples:

> *The machine was correct. The decision was still wrong.*
>
> *The system had more data. The operator had more context.*
...
End without a checklist, summary, or management recommendation. Give the reader the next loss or responsibility.

::: {.memorable-phrase}
A single durable sentence of 12–18 words.
:::

::: {.next-chapter}
The next question that this chapter makes impossible to avoid.
:::
