...
\subsection{The Moment an Answer Becomes an
...
\begin{quote}
\subsubsection{Evidence Note: The Operational
Threshold}\label{evidence-note-the-operational-threshold}
...
\subsection{Software Has Always Acted}\label{software-has-always-acted}
...
\begin{quote}
\subsubsection{The Difference That
Matters}\label{the-difference-that-matters}
...
\subsection{The First Four Questions}\label{the-first-four-questions}
...
\subsection{The Human Role Does Not
...
\textbf{An agent may complete the work. It cannot inherit the
organisation's responsibility for deciding that the work should have
been done.}

The human remainder is not a residual task list. It is the judgment that
determines acceptable scope, acceptable harm and the point at which
delegation must stop.
\end{quote}
