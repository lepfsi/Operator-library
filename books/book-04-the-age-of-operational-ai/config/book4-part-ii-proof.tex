...
\newcommand{\chapterSixOpener}{%
\phantomsection\addcontentsline{toc}{section}{6. The AI Has Credentials}
\renewcommand{\CurrentRunningHead}{THE AI HAS CREDENTIALS}
\clearpage\thispagestyle{empty}\vspace*{0.18\textheight}
{\sffamily\fontsize{8}{10}\selectfont\color{QuietUmber}PART II · CHAPTER 6}\par\vspace{18pt}
{\sffamily\fontsize{30}{34}\selectfont\bfseries THE AI HAS\\ CREDENTIALS}\par\vspace{19pt}
{\itshape\large A system becomes operationally powerful when another system accepts its identity.}\par\vfill
{\sffamily\fontsize{7}{9}\selectfont\color{WarmGrey}THE NEW ATTACK SURFACE}\clearpage}
\newcommand{\chapterSixCoda}{%
...
{\large A credential is not a configuration detail.\\[7pt]
It is an authority decision another system will enforce.\\[7pt]
Every agent identity needs an owner, a boundary and a lifecycle.}\par\vspace{30pt}
\noindent\rule{0.25\textwidth}{0.5pt}\par\vspace{12pt}
{\itshape\large Once an agent has a credential, the next question is not whether it can act. It is who owns the actor that acts.}\par\vfill
{\sffamily\fontsize{7}{9}\selectfont\color{WarmGrey}NEXT · WHO OWNS AN AI AGENT?}\clearpage}
\newcommand{\chapterSevenOpener}{%
\phantomsection\addcontentsline{toc}{section}{7. Who Owns an AI Agent?}
\renewcommand{\CurrentRunningHead}{WHO OWNS AN AI AGENT?}
\clearpage\thispagestyle{empty}\vspace*{0.18\textheight}
{\sffamily\fontsize{8}{10}\selectfont\color{QuietUmber}PART II · CHAPTER 7}\par\vspace{18pt}
{\sffamily\fontsize{30}{34}\selectfont\bfseries WHO OWNS AN\\ AI AGENT?}\par\vspace{19pt}
{\itshape\large An agent is owned only when someone can change its mandate and answer for its effect.}\par\vfill
{\sffamily\fontsize{7}{9}\selectfont\color{WarmGrey}THE NEW ATTACK SURFACE}\clearpage}
\newcommand{\chapterSevenCoda}{%
\clearpage\thispagestyle{empty}\vspace*{0.22\textheight}
{\sffamily\fontsize{8}{10}\selectfont\color{QuietUmber}CHAPTER CODA}\par\vspace{18pt}
{\sffamily\fontsize{23}{28}\selectfont\bfseries WHAT REMAINS}\par\vspace{18pt}
{\large Ownership is not product administration.\\[7pt]
It is the power to define, stop and explain an agent’s mandate.\\[7pt]
No agent can own the conditions that made its action permissible.}\par\vspace{30pt}
\noindent\rule{0.25\textwidth}{0.5pt}\par\vspace{12pt}
{\itshape\large An ownership gap is an attack surface because it leaves no one able to change the boundary when the system is influenced from outside.}\par\vfill
{\sffamily\fontsize{7}{9}\selectfont\color{WarmGrey}NEXT · PROMPT INJECTION IS NOT THE WHOLE PROBLEM}\clearpage}
...
\input{../chapter-06-body-v3.tex}
\chapterSixCoda
\chapterSevenOpener
\setcounter{section}{0}
\input{../chapter-07-body-v3.tex}
\chapterSevenCoda
\sourceNotesOpener
{\sffamily\bfseries\large Chapter 6}\par\vspace{10pt}
\begin{enumerate}\itemsep=8pt
\item Vercel, \emph{Vercel April 2026 security incident}, April 2026.
\item National Institute of Standards and Technology, \emph{AI Agent Standards Initiative}, updated August 14, 2026.
\item OWASP GenAI Security Project, \emph{OWASP Top 10 for Agentic Applications for 2026}, December 2025.
\end{enumerate}
\vspace{18pt}
{\sffamily\bfseries\large Chapter 7}\par\vspace{10pt}
\begin{enumerate}\itemsep=8pt
\item Federal Trade Commission, \emph{FTC Launches Inquiry into AI Chatbots Acting as Companions}, September 11, 2025.
\item National Institute of Standards and Technology, \emph{AI Agent Standards Initiative}, updated August 14, 2026.
\item National Institute of Standards and Technology, \emph{CAISI Issues Request for Information About Securing AI Agent Systems}, January 12, 2026.
\item OWASP GenAI Security Project, \emph{OWASP Top 10 for Agentic Applications for 2026}, December 2025.
\end{enumerate}
\vspace{20pt}
{\sffamily\bfseries\large Further Reading}\par\vspace{10pt}
Vercel. \emph{Vercel April 2026 security incident}.\\
